<div class="container-lg hero mt-5">
  <div class="row row-cols-1 row-cols-md-3 gap-4 justify-content-center justify-content-xl-start" id="livesearch">
    ...
    foreach ($movies as $item) {
      ...
      $genre = $item[2];
      $release_year = $item[3];
      $image = "http://localhost/projects/project/" . substr($item[4], 3);
      $likes = $item[6];
    ?>
      <a href="http://localhost/projects/project/pages/movie_details.php?id=<?php echo $id ?>" class="col" style="max-width: 300px; text-decoration: none; color: black;">
