...
?>
  <!-- signup -->
  <div class="auth-wrapper d-flex flex-column justify-content-center align-items-center text-white" style="max-width: 500px; margin: 0 auto;">
    <!-- auth logo -->
    <div class="auth-logo">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center">
      ...
      <p class="text-white mt-2">
        Already a member? <a href="http://localhost/projects/project/components/auth/login.php" style="color: cyan;">Sign in</a> instead.
      </p>
    </div>
  <?php
} else {
