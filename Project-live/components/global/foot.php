  ...
  function handleSearch(query) {
    ...
    if (!query) {
      ...
      for (let movie of movies) {
        ...
        htmlText +=
          `
            <a href="https://cse-482.000webhostapp.com/pages/movie_details.php?id=${id}" class="col" style="max-width: 300px; text-decoration: none; color: black;">
              <div class="card movie-card">
                <div style="width: 100%;">
                  <div style="overflow: hidden; position: relative; width: 100%; padding-bottom: 95%;">
                    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
                      <img src="https://cse-482.000webhostapp.com/${image.slice(3)}" alt="" style="object-fit: cover; height: 100%; width: 100%;" />
                    </div>
                  </div>
                </div>
