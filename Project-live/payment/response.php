...
try {
    ...
    try {
        ...
        if (addPayment($data) !== false && $data['payment_status'] === 'approved') {
            ...
            header("location:https://cse-482.000webhostapp.com//payment/PaypalSuccess.php?payid=$inserids");
            exit(1);
        } else {
            // Payment failed
            header("location:https://cse-482.000webhostapp.com/payment/PaypalFailed.php");
            exit(1);
        }
    } catch (Exception $e) {
